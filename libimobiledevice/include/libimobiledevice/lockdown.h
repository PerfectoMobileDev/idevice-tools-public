...
#define LOCKDOWN_E_SERVICE_LIMIT			 -22
...
LIBIMOBILEDEVICE_API lockdownd_error_t lockdownd_stop_service(lockdownd_client_t client, const char *identifier);


LIBIMOBILEDEVICE_API int lockdownd_client_get_os_version(idevice_t device);
LIBIMOBILEDEVICE_API void lockdown_reset_SSL_mode();
