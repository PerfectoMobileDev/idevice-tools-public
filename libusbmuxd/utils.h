...
LIBUSBMUXD_API void collection_init(struct collection *col);
LIBUSBMUXD_API void collection_add(struct collection *col, void *element);
LIBUSBMUXD_API void collection_remove(struct collection *col, void *element);
LIBUSBMUXD_API int collection_count(struct collection *col);
LIBUSBMUXD_API void collection_free(struct collection *col);
